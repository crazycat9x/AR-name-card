				...
				(e.calculateBackgroungPositioningArea = function(A, e, t, r) {
					...
					switch (A) {
						case Q.BORDER_BOX:
							return e;
						case Q.CONTENT_BOX:
							var B = t[o.PADDING_SIDES.LEFT].getAbsoluteValue(
									e.width
								),
								a = t[o.PADDING_SIDES.RIGHT].getAbsoluteValue(
									e.width
								),
								i = t[o.PADDING_SIDES.TOP].getAbsoluteValue(
									e.width
								),
								c = t[o.PADDING_SIDES.BOTTOM].getAbsoluteValue(
									e.width
								);
							return new s.Bounds(
								n.left + B,
		...
		function(A, e, t) {
			...
			var i = ["OL", "UL", "MENU"],
				...
				(e.inlineListItemElement = function(A, e, t) {
					...
					if (s) {
						var o = A.ownerDocument.defaultView.getComputedStyle(
								A,
								null
							),
							i = A.ownerDocument.createElement(
								"html2canvaswrapper"
							);
						switch (
													...
													function(e) {
														switch (e) {
															case B
																...
																.UNDERLINE:
																var r = a.options.fontMetrics.getMetrics(
																	t
																).baseline;
																a.rectangle(
																	A.bounds
															...
															case B
																.TEXT_DECORATION_LINE
																.LINE_THROUGH:
																var n = a.options.fontMetrics.getMetrics(
																	t
																).middle;
																a.rectangle(
																	A.bounds
							...
							},
							{
								...
								value: function(A, e) {
									if (
										...
										return A;
									var t = this.canvas.ownerDocument.createElement(
										"canvas"
									);
									return (
										(t.width = e.width),
		...
		function(A, e, t) {
			...
			var u = new o.default([165, 165, 165]),
				...
				function(A, e, t, n) {
					...
					if (A.length > 0 && B) {
						var a = e.ownerDocument.createElement(
							"html2canvaswrapper"
						);
						(0, c.copyCSSStyles)(
			...
			var i = (e.TextBounds = function A(e, t) {
				...
				function(A, e, t) {
					...
					if (B) {
						...
						return (
							r.firstChild && B.replaceChild(r.firstChild, r), a
						);
					}
		...
		function(A, e, t) {
			...
			e.renderElement = function A(e, t, Q) {
				...
				return (t.foreignObjectRendering
					...
					return s
						? (u = new i.DocumentCloner(e, t, Q, !0, A))
								.inlineFonts(w)
								.then(function() {
							...
							},
							{
								...
								value: function(A) {
									...
									if (
										...
										var t = A.ownerDocument.createElement(
											"img"
										);
										try {
							...
							for (var a = r.length, s = 0; s < a; s++) {
								...
								switch (c.type) {
									case l.PSEUDO_CONTENT_ITEM_TYPE.IMAGE:
										var u = e.ownerDocument.createElement(
											"img"
										);
					...
					n(A, [
						...
						},
						{
							...
							value: function(A) {
								var e =
									this._link ||
									(this._link = this._window.document.createElement(
										"a"
									));
								return (
									(e.href = A),
